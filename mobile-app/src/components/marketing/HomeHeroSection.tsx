  ...
  return (
    <View className="flex-1 bg-slate-950">
      ...
      >
        ...
        <View className="px-4 sm:px-6 pb-4 pt-2 flex-row items-center justify-between border-b border-slate-800/80">
          <View className="flex-row items-center gap-2.5 flex-1 mr-2">
            <View className="w-10 h-10 rounded-xl bg-blue-600/20 border border-blue-500/40 items-center justify-center shrink-0">
              <Shield color="#38bdf8" size={22} />
            </View>
            <View className="shrink">
              <Text className="text-white font-black text-base sm:text-lg tracking-tight" numberOfLines={1}>
          ...
          <View className="flex-row items-center gap-2 shrink-0">
            ...
            {isLoggedIn ? (
              <TouchableOpacity
                ...
                className="flex-row items-center gap-1.5 bg-blue-600 active:bg-blue-700 px-3.5 py-2 rounded-xl"
              >
              ...
              <View className="flex-row items-center gap-1.5">
                <TouchableOpacity
                  ...
                  className="flex-row items-center gap-1 px-2.5 py-1.5 rounded-xl bg-slate-900 border border-slate-800 active:bg-slate-800"
                >
                  <LogIn color="#94a3b8" size={14} />
        ...
        <View className="px-4 sm:px-6 pt-8 pb-6 items-center">
          {/* Badge */}
          <View className="flex-row items-center gap-1.5 px-3 py-1.5 rounded-full bg-blue-500/10 border border-blue-500/30 mb-5">
            <Sparkles color="#38bdf8" size={13} />
            <Text className="text-sky-300 text-[11px] font-bold uppercase tracking-wider text-center">
              Women Safety & Emergency SOS System
            </Text>
          </View>

          {/* Main Title */}
          <Text className="text-3xl sm:text-5xl font-black text-white text-center tracking-tight leading-tight">
            ढोल - ताशा
          </Text>
          <Text className="text-3xl sm:text-5xl font-black text-sky-400 text-center tracking-tight leading-tight mb-4">
            महासंघ
          </Text>

          {/* Subtitle */}
          <Text className="text-slate-300 text-center text-sm sm:text-base font-medium leading-relaxed max-w-lg mb-6 px-2">
          ...
          <View className="w-full max-w-md flex-col sm:flex-row items-center justify-center gap-3">
            {isLoggedIn ? (
              ...
              <>
                ...
                <TouchableOpacity
                  onPress={() => router.push('/(auth)/login' as any)}
                  className="w-full sm:flex-1 flex-row items-center justify-center gap-2 bg-slate-900 border-2 border-slate-700 py-3.5 px-5 rounded-2xl active:bg-slate-800"
                >
        ...
        <View className="px-3 sm:px-5 mt-4">
          <View className="rounded-3xl border border-slate-800 bg-slate-900/90 p-4 sm:p-6 shadow-xl">
            {/* Header */}
            <View className="pb-4 mb-4 border-b border-slate-800/80">
              <View className="flex-row items-center justify-between gap-2 mb-2">
                <View className="flex-row items-center gap-2.5 flex-1">
                  <View className="w-10 h-10 rounded-xl bg-blue-500/20 border border-blue-500/40 items-center justify-center shrink-0">
                    <Sparkles color="#38bdf8" size={20} />
                  </View>
                  <Text className="text-lg sm:text-xl font-black text-white tracking-tight shrink">
                ...
                <View className="flex-row items-center gap-1 rounded-full border border-blue-500/30 bg-blue-500/10 px-2.5 py-1 shrink-0">
                  <ShieldAlert color="#38bdf8" size={12} />
                  <Text className="text-[10px] font-bold uppercase tracking-wider text-blue-300">
                    Safety
                  </Text>
                </View>
              </View>

              <Text className="text-xs font-semibold text-slate-400 pl-0.5">
            ...
            <View className="space-y-3">
              ...
              <View className="rounded-2xl border border-slate-800 bg-slate-950/70 p-3.5 mb-2.5">
                <View className="flex-row items-start gap-3">
                  <View className="w-9 h-9 rounded-xl bg-blue-500/15 border border-blue-500/30 items-center justify-center shrink-0 mt-0.5">
                    <UserCheck color="#60a5fa" size={18} />
                  </View>
              ...
              <View className="rounded-2xl border border-slate-800 bg-slate-950/70 p-3.5 mb-2.5">
                <View className="flex-row items-start gap-3">
                  <View className="w-9 h-9 rounded-xl bg-rose-500/15 border border-rose-500/30 items-center justify-center shrink-0 mt-0.5">
                    <PhoneCall color="#fb7185" size={18} />
                  </View>
                  <View className="flex-1">
                    <Text className="text-sm font-bold text-white mb-1">
                      थेट कॉल व मेसेज
            ...
            <View className="mt-3 pt-3 border-t border-slate-800/60 flex-row items-center justify-between">
              <View className="flex-row items-center gap-1.5">
              ...
              >
                ...
                <ArrowRight color="#fb7185" size={12} />
              </TouchableOpacity>
            </View>
          </View>
        </View>
        ...
        <View className="px-4 sm:px-6 mt-10">
          <View className="items-center mb-6">
            <Text className="text-xl sm:text-2xl font-black text-white text-center mb-1.5 tracking-tight">
              Why ढोल - ताशा महासंघ?
            </Text>
            <Text className="text-[10px] font-bold uppercase tracking-widest text-sky-400 text-center">
          ...
          <View className="space-y-3">
            {/* Feature 1 */}
            <View className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 mb-3">
              ...
              <Text className="text-base font-black text-white mb-1">Instant Emergency SOS</Text>
            ...
            <View className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 mb-3">
              ...
              <Text className="text-base font-black text-white mb-1">Secure Organization Access</Text>
              <Text className="text-slate-300 text-xs font-medium leading-relaxed">
            ...
            <View className="rounded-2xl border border-slate-800 bg-slate-900/60 p-4 mb-3">
              <View className="w-10 h-10 rounded-xl bg-emerald-500/15 border border-emerald-500/30 items-center justify-center mb-3">
                <BarChart3 color="#34d399" size={20} />
              </View>
              <Text className="text-base font-black text-white mb-1">Automated Incident Alerting</Text>
              <Text className="text-slate-300 text-xs font-medium leading-relaxed">
        ...
        <View className="px-3 sm:px-5 mt-8">
          <View className="rounded-3xl border border-blue-900/40 bg-slate-900 p-5">
            <View className="items-center mb-4">
              <Text className="text-lg sm:text-xl font-black text-white text-center leading-snug mb-3">
              ...
              <View className="flex-row flex-wrap justify-center gap-1.5 mb-4">
                {['Live SOS', 'GPS Tracking', 'Direct Call', 'Verified Teams'].map((tag) => (
                  ...
                  >
                    <Text className="text-blue-300 font-bold text-[9px] uppercase tracking-wider">
                      {tag}
                    </Text>
                  </View>
                ))}
            ...
            {/* Stats Grid */}
            <View className="bg-slate-950/90 border border-slate-800 rounded-2xl p-4">
              <View className="flex-row justify-between mb-3">
                <View className="items-center flex-1">
                  <Text className="text-xl font-black text-white">50K+</Text>
                  <Text className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                    Protected Alerts
                  </Text>
                </View>
                <View className="w-px bg-slate-800 h-8 self-center" />
                <View className="items-center flex-1">
              ...
              <View className="flex-row justify-between mt-3">
                <View className="items-center flex-1">
                  <Text className="text-xl font-black text-emerald-400">99.9%</Text>
                  <Text className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                    Uptime
                  </Text>
                </View>
                <View className="w-px bg-slate-800 h-8 self-center" />
                <View className="items-center flex-1">
                  <Text className="text-xl font-black text-sky-400">24/7</Text>
                  <Text className="text-[9px] font-bold text-slate-400 uppercase tracking-widest mt-0.5">
                    Support
                  </Text>
                </View>
        ...
        {/* 6. Footer */}
        <View className="px-4 mt-8 pt-6 border-t border-slate-800/80 items-center">
          <Text className="text-slate-400 font-bold text-xs text-center mb-1">
